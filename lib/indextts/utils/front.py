...
class TextTokenizer:
    ...
    punctuation_marks_tokens = [
        ...
        "▁?",
        "▁...",
        ",",  # Added for comma splitting
        "▁,",  # Added for comma splitting
    ]
    def split_segments(self, tokenized: List[str], max_text_tokens_per_segment=300, quick_streaming_tokens=0) -> List[List[str]]:  # Raised default limit to 300
